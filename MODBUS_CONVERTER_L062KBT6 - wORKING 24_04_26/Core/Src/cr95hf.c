...
//		if (state == 39 && Read_Done == 1){		//	if (state == 39 && Read_Done == 1){
//			//DBG_Print("Read done.\r\n\r\n");
//			DBG_Print("Read done.\r\n\r\n");
//			return;
//		}
...
void CR95HF_Process2(void) {
    switch (state) {
        ...
        case 1:  // Reset + Protocol + Inventory flow
            ...
            CR95HF_Send1((uint8_t*)"\x04\x03\xC2\xFF\x28", 5, 2); WaitRx(50);
            CR95HF_Send1((uint8_t*)"\x02\x05\x02\x00\x00\x10\x00", 7, 2); WaitRx(50);
        ...
        case 10: // Sector Select
            ...
            CR95HF_Send1((uint8_t*)"\x04\x05\x03\x00\x00\x00\x28", 7, 2); WaitRx(50);
            state = 11;
            break;

        case 11:
            DBG_Print("STATE 11: PAGE READ F8\r\n");
            CR95HF_Send1((uint8_t*)"\x04\x03\x30\xF8\x28", 5, 2); WaitRx(50);
        ...
        case 12: // Guard Delay
            ...
            CR95HF_Send1((uint8_t*)"\x04\x05\x00\x00\x00\x00\x28", 7, 2); WaitRx(50);
            state = 14;
            break;
